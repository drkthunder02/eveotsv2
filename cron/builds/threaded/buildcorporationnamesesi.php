...
function BuildCorporationNamesESI($idFrom, $idTo) {
    ...
    $Corporations = $db->fetchRowMany('SELECT * FROM Corporations WHERE id>= :idFrom AND id< :idTo', array('idFrom' => $idFrom, 'idTo' => $idTo));
    $count = $idTo - $idFrom;
